...
$(function(){
	...
	$('.toAccount').on('click',function(){
		...
		var url = getRootPath() + '/busweb/account.html?shop_id=' + shop_id + '&origin=' + origin + '&isauth=' + isauth;
		if(origin == 'adr'){
            APP.appToUrl(url);
        }else if(origin == 'ios'){
	...
	$('.toPayHistory').on('click',function(){
		var url =  getRootPath() + 'busweb/payHistory.html?shop_id=' + shop_id + '&origin=' + origin + '&isauth=' + isauth;
		if(origin == 'adr'){
            APP.appToUrl(url);
        }else if(origin == 'ios'){
            window.webkit.messageHandlers.appToUrl.postMessage(url);
	...
	$('.toconsum').on('click',function(){
		var url = getRootPath() + 'busweb/consum.html?shop_id='+shop_id+'&origin='+origin;
		if(origin == 'adr'){
            APP.appToUrl(url);
        }else if(origin == 'ios'){
            window.webkit.messageHandlers.appToUrl.postMessage(url);
	...
	$('.todiscountconsum').on('click',function(){
		var url = getRootPath() + 'busweb/countconsum.html?shop_id='+shop_id+'&origin='+origin;
		if(origin == 'adr'){
            APP.appToUrl(url);
        }else if(origin == 'ios'){
            window.webkit.messageHandlers.appToUrl.postMessage(url);
