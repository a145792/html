...
(function(){
    ...
    var defaults,
        ...
        createDate,
        emptyStr = "<li></li>",
        domHm = '<div class="t4">月</div><div class="t5">日</div>',
    ...
    createDate = {
        ...
        hm:function(){
            ...
            for (var j = 1; j <= 12; j++) {j = j<10?'0'+j:j;domMonth += '<li><span>' + j + '</span></li>';}
            $('#d-hours').append(emptyStr + domMonth + emptyStr);
            var day = createDate.bissextile(nowYear,nowMonth);
            for (var k = 1; k <= day; k++) {k = k<10?'0'+k:k;domDay += '<li><span>' + k + '</span></li>';}
            $('#d-minutes').append(emptyStr + domDay + emptyStr);
        },
        //hm:function(){
        ...
        //
        //    for (var j = 0; j <= 23; j++) {j = j<10?'0'+j:j;domMinutes += '<li><span>' + j + '</span></li>';}
        ...
        slide:function(el){
            ...
            $(document).on(tmove,'#date-wrapper ol', function(e){
                ...
                if($('#d-bg').hasClass('limitTime')){
                    ...
                    }else if(that.attr('id') == 'd-hours' && that.position().top > mTop){
                        that.css('top', mTop + 'px');
                    }else if(that.attr('id') == '#d-minutes' && that.position().top > dTop){
                        that.css('top', dTop + 'px');
                    }
                }
            ...
            function dragEnd(that){
                ...
                if(id == 'd-hours'){
                    ...
                    if(day1 != ($('#d-minutes li').length-2)){
                        ...
                        var str1 = '';
                        for (var j = 1; j <= day1; j++) {
                            if (j == thisActive1) {
                                str1 += '<li class="active"><span>' + j + '</span></li>';
                            } else {
                                str1 += '<li><span>' + j + '</span></li>';
                            }
                        }
                        $('#d-minutes').html(emptyStr + str1 + emptyStr);
                        if(Math.abs($('#d-minutes').position().top) > $('#d-minutes').height()-120)$('#d-minutes').css('top','-'+($('#d-minutes').height()-120)+'px');
                    }
                }
            }
        },
            ...
            $('#date-wrapper ol').each(function() {
                ...
                e.children('li').each(function() {
                    ...
                    if (eId == 'd-year' && liText == d.getFullYear()) {
                        ...
                        lie.addClass('active').siblings().removeClass('active');
                        return false;
                    } else if (eId == 'd-hours' && liText == (d.getMonth() + 1)) {
                        lie.addClass('active').siblings().removeClass('active');
                        return false;
                    } else if (eId == 'd-minutes' &&liText == d.getDate()) {
                        lie.addClass('active').siblings().removeClass('active');
                        return false;
            ...
            if (!$('#date-wrapper').is(':visible')) {
                ...
                if(activeEl != obj){
                    ...
                    if(opt.type == "YYYY-MM-DD hh:mm:ss"){
                        ...
                        $('#d-bg ol:gt(2)').remove();
                        $('#d-tit').append(domHm);
                        $('#d-bg').append(domHm2);createDate.hm();
